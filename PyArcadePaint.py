...
def on_mouse_release(x, y, button, modifiers):
    ...
    if x > 100:
        ...
        pymsgbox.alert(text='You exported the drawing as Python Arcade code in Exported_Code.py in this project\'s folder. Copy & paste it into an Arcade template, then run it. Your drawing should appear. Read the README.md on my GitHub repo for more details.', title='Successfully Exported!')
